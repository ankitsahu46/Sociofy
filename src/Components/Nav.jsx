...
function Nav({handleClick, ...navInfo}) {
  ...
  return (
    <>
      <a href={navigateTo} className="flex xl:justify-start xl:w-full rounded-2xl md:mb-3 xl:pl-2  transition-all xl:hover:bg-gray-200 select-none outline-none order-2">
