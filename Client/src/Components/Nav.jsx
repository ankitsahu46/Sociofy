...
function Nav({ handleClick, ...navInfo }) {
  ...
  return (
    <>
      <a href={navigateTo} rel="noreferrer" className="flex xl:justify-start xl:w-full rounded-2xl md:mb-3 transition-all xl:hover:bg-gray-200 select-none outline-none order-2">
